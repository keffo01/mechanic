...
<body>
	<div class="row">
		...
		<div  class="col-md-12 mx-auto col-xs-9">
			<div id="contenido">
				<?=$Navbar?>
				<form method="POST" action="<?=base_url('Compra/GuardarCompra')?>" class="container " style="padding: 15px;" enctype="multipart/form-data">
					<div class="card" >
						...
						<fieldset class="card-content border" style="padding: 15px;">
							<div class="row" >
								...
								<div class="col-md-4">
									<label >Monto</label>
									<input type="number" name="Monto_compra" class="form-control" placeholder="$0.00">
								</div>
								<div class="col-md-1"></div>
							</div>
							<div class="row" >
								...
								<div class="col-md-4">
									...
									<input type="text" name="Proveedor" class="form-control" placeholder="Cliente">
								</div>
								<div class="col-md-1"></div>
							</div>
							<div class="row">
